...
private val BS_DATES: Array<Array<Int>> = arrayOf(
    ...
    arrayOf(2082, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2083, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2084, 31, 31, 32, 31, 32, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2085, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2086, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2087, 30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31),
    arrayOf(2088, 31, 31, 32, 31, 32, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2089, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2090, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2091, 31, 31, 32, 31, 32, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2092, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2093, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2094, 31, 31, 32, 31, 32, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2095, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2096, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2097, 30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31),
    arrayOf(2098, 31, 31, 32, 31, 32, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2099, 31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 29, 31),
    arrayOf(2100, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31)
)
